...
class ViewController: UIViewController {
    ...
    @IBAction func getImage(_ sender: Any) {
        ...
        do{
            let url = URL(string: "https://img.moegirl.org/common/thumb/4/41/Nicky.jpg/250px-Nicky.jpg")
            if url != nil {
    ...
    @IBAction func testGet(_ sender: Any) {
        do {
            ...
            let urlString = "http://10.2.12.151/brad.php?account=\(account!)&passwd=\(passwd!)";
